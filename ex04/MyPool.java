        ...
        public void run() {
            ...
            while (true) {
                synchronized(queue) {
                    ...
                    // espera ocupada até queue.isEmpty() retornar verdadeiro
                    // após a chamada de shutdown() na pool de threads
...
class Primo implements Runnable {
    //...completar implementacao, recebe um numero inteiro positivo e imprime
    // se esse numero eh primo ou nao
    private int numero;
    public Primo(int n) {
        this.numero = n;
    }
    ...
    public void run() {
        ...
        if (ehPrimo(this.numero)) {
            msg = this.numero + " é primo";
        } else {
            msg = this.numero + " não é primo";
        }
